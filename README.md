...
[:computer:Windows版下载](https://hub.fastgit.org/dodois/Doisnet/releases/download/v0.0.7/doisnet-0.0.7.Setup.exe)
...
###### windows 解决办法
1. 下载[最新版Doisnet](https://hub.fastgit.org/dodois/Doisnet/releases/download/v0.0.7/doisnet-0.0.7.Setup.exe)
2. 启动
